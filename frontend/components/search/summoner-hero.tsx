...
export function SummonerHero({ result }: SummonerHeroProps) {
  return (
    <section className="rounded-2xl border border-white/10 bg-slate-900 p-6 shadow-xl shadow-black/20">
      <div className="flex flex-col gap-5 md:flex-row md:items-center">
        ...
        <div className="min-w-0 space-y-3">
          <div className="flex flex-wrap items-center gap-3">
            <span className="rounded-md bg-cyan-400/12 px-3 py-1 text-xs font-medium text-cyan-200">
              {result.region}
            </span>
          </div>
